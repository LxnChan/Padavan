...
TERMINFO="/opt/rt-n56u/trunk/stage/share/terminfo"
...
(*.[0-9]*)
	...
	if test ! -f /opt/rt-n56u/trunk/libs/libncurses/ncurses-6.2/man_alias.sed ; then
cat >>/opt/rt-n56u/trunk/libs/libncurses/ncurses-6.2/man_alias.sed <<-CF_EOF2
		s,@DATADIR@,$datadir,g
...
s,@TSET@,tset,g
CF_EOF2
		echo "...made /opt/rt-n56u/trunk/libs/libncurses/ncurses-6.2/man_alias.sed"
	fi
	...
	aliases=`sed -f $top_srcdir/man/manlinks.sed $inalias |sed -f /opt/rt-n56u/trunk/libs/libncurses/ncurses-6.2/man_alias.sed | sort -u; test $inalias = $nCurses && echo curses`
	cf_target=`grep "^$cf_source" /opt/rt-n56u/trunk/libs/libncurses/ncurses-6.2/man/man_db.renames | mawk '{print $2}'`
	...
	sed	-f /opt/rt-n56u/trunk/libs/libncurses/ncurses-6.2/man_alias.sed \
		< $i | sed -f /opt/rt-n56u/trunk/libs/libncurses/ncurses-6.2/edit_man.sed >$TMP
